pipeline {
  ...
  environment {
    ...
    EXT_USER = 'imputnet'
    EXT_REPO = 'helium-linux'
    BUILD_VERSION_ARG = 'HELIUM_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-helium'
    CONTAINER_NAME = 'helium'
    DOCKERHUB_IMAGE = 'linuxserver/helium'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/helium'
    PR_DOCKERHUB_IMAGE = 'lspipepr/helium'
    DIST_IMAGE = 'debian'
    MULTIARCH = 'true'
    CI = 'true'
    CI_WEB = 'true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-helium/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-helium\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-helium\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Helium\" \
          --label \"org.opencontainers.image.description=[Helium](https://helium.computer/) is a Chromium-based web browser made for people, with love. Privacy-first with unbiased ad-blocking.\" \
